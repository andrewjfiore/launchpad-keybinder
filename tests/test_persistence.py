...
class TestPersistenceDir:
    ...
    def test_env_override(self):
        """Test LAUNCHPAD_MAPPER_DATA_DIR overrides default location."""
        with tempfile.TemporaryDirectory() as tmpdir:
            override = Path(tmpdir) / "custom_persist"
            with patch.dict(os.environ, {"LAUNCHPAD_MAPPER_DATA_DIR": str(override)}):
                result = get_persistence_dir()
